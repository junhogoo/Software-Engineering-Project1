...
public class MainActivity extends AppCompatActivity{
    public List<Login_item> login_itemList;
    EditText inputId;
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0; i<login_itemList.size(); i++){
                    if(id.compareTo(login_itemList.get(i).ID)==0) {
                        if(password.compareTo(login_itemList.get(i).PWD)==0){
                            String nicknmae = login_itemList.get(i).NICKNAME;
                            power = login_itemList.get(i).POWER;
