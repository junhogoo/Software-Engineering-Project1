...
public class Community_Detail_Fragment extends Fragment {
    ...
    Fragment community_detail_fragment;
    Community_Edit_Fragment community_Edit_Fragment;
    Button communtiy_detail_edit_btn,communtiy_detail_delete_btn;
    Button community_detail_back_btn,community_detail_good_btn,community_detail_bad_btn;
    TextView community_detail_title,community_detail_nickname,community_detail_content;
    TextView community_detail_like_num,community_detail_unlike_num;
    Community_Item item;
    CommunityDataAdapter adapter;
