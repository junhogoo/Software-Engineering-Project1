...
public class Community_Add_Fragment extends Fragment {
    ...
    Fragment community_add_fragment;

    Button community_add_complete_btn,community_add_image_btn,community_add_cancel_btn;
    EditText community_add_title,community_add_content;
